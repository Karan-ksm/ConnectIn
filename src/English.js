...
function ChatRoom() {
  const dummy = useRef();
  const messagesRef = firestore.collection('englishmessages'); // Use 'englishmessages' here
  ...
  return (
    <>
      ...
      <form onSubmit={sendMessage}>
        <input value={formValue} onChange={(e) => setFormValue(e.target.value)} placeholder="ConnectIn: English" />
