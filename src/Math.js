...
// Initialize your Firebase app (replace with your own config)
...
function ChatRoom() {
  const dummy = useRef();
  const messagesRef = firestore.collection('mathmessages'); // Use 'mathmessages' here
  ...
  return (
    <>
      ...
      <form onSubmit={sendMessage}>
        <input value={formValue} onChange={(e) => setFormValue(e.target.value)} placeholder="ConnectIn: Math" />
